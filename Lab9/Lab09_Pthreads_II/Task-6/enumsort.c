...
/*
Enumeration is n^2, so it should be slower than the other methods. 

Before:
Time: 5.130351  NUM_THREADS: 5

After: 
Time: 1.185490  NUM_THREADS: 5  nr_per_thread: 10 
Time: 0.825096  NUM_THREADS: 5  nr_per_thread: 100 
